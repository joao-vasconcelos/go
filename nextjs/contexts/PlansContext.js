...
export function PlansContextProvider({ children }) {
	//
	...
	const { data: allItemsData } = useSWR('/api/plans');
	...
	return <PlansContext.Provider value={contextObject}>{children}</PlansContext.Provider>;
