...
export default async function handler(req, res) {
	...
	try {
		...
		await SLAMANAGERBUFFERDB.BufferData.deleteMany({ operational_day: { $eq: req.query.operational_day }, type: 'vehicle_event' });

		await SLAMANAGERBUFFERDB.OperationalDayStatus.updateOne({ operational_day: { $eq: req.query.operational_day } }, { $set: { vehicle_event_synced: false } });
