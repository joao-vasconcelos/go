...
export default async function handler(req, res) {
	...
	try {
		...
		await SLAMANAGERBUFFERDB.OperationalDayStatus.updateOne({ operational_day: { $eq: req.query.operational_day } }, { $set: { location_transaction_synced: false, validation_transaction_synced: false, vehicle_event_synced: false } });
