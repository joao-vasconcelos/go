...
export default function PatternsExplorerIdPageImport() {
	...
	const TableHeader = () => <div className={styles.tableHeader}>
	...
	const TableBody = () => <div className={styles.tableBody}>
		{parseResult.map((trip) => <div className={styles.tableBodyRow} key={trip.trip_id}>
	...
	const ParsingResults = () => <div className={styles.container}>
