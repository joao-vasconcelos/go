  ...
  return (
    <ListHeader>
      ...
      <AppAuthenticationCheck permissions={[{ scope: 'lines', action: 'lock' }]}>
        <LockButton isLocked={linesExplorerContext.item_data?.is_locked} onClick={linesExplorerContext.lockItem} />
      </AppAuthenticationCheck>
      <AppAuthenticationCheck permissions={[{ scope: 'lines', action: 'delete' }]}>
        <DeleteButton onClick={handleDelete} disabled={linesExplorerContext.page.is_read_only} />
      </AppAuthenticationCheck>
    </ListHeader>
  );
}
