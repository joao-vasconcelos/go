  ...
  return (
    <>
      ...
      <AppLayoutSection title={t('sections.onboard.title')} description={t('sections.onboard.description')}>
        <SimpleGrid cols={4}>
          <StatCard label={t('metrics.onboard_qty.label')} value={formattedMetricsZapping.qty} displayValue={t('metrics.onboard_qty.value', { value: formattedMetricsZapping.qty })} />
          <StatCard label={t('metrics.onboard_euro.label')} value={formattedMetricsZapping.euro} displayValue={t('metrics.onboard_euro.value', { value: formattedMetricsZapping.euro })} />
        </SimpleGrid>
      </AppLayoutSection>
      <Divider />
      <AppLayoutSection title={t('sections.onboard.title')} description={t('sections.onboard.description')}>
