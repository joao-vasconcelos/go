  ...
  return (
    <div className={styles.container}>
      <div className={styles.mediaList}>
        {stopsExplorerContext.form.values.media.map((mediaId) => (
          <MediaExplorerMedia key={mediaId} mediaId={mediaId} onDelete={handleMediaDelete} readOnly={stopsExplorerContext.page.is_read_only} />
        ))}
