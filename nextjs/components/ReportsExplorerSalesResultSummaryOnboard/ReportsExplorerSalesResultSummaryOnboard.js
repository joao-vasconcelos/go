...
import ReportsExplorerSalesResultSummaryOnboardDownload from '@/components/ReportsExplorerSalesResultSummaryOnboardDownload/ReportsExplorerSalesResultSummaryOnboardDownload';

/* * */

export default function ReportsExplorerSalesResultSummaryOnboard() {
  //

  //
  // A. Setup variables

  const t = useTranslations('ReportsExplorerSalesResultSummaryOnboard');
  ...
  return (
    <AppLayoutSection title={t('title')} description={t('description')}>
      ...
      <ReportsExplorerSalesResultSummaryOnboardDownload />
    </AppLayoutSection>
  );
