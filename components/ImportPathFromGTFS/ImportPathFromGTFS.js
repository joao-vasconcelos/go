...
import styles from './ImportPathFromGTFS.module.css';
...
export default function ImportPathFromGTFS({ onImport }) {
  //

  //
  // A. Setup variables

  const t = useTranslations('ImportPathFromGTFS');
  ...
  const handlePathImport = (trip) => {
    ...
    // setIsParsing();
    // setHasParseError();
    notify('path-import', 'success', t('import.success', { trip_id: trip.trip_id }));
  };
