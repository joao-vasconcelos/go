...
export default async function handler(req, res) {
  ...
  try {
    ...
    const foundDocumentWithCode = await FareModel.exists({ code: { $eq: req.body.code } });
  ...
  try {
    const editedDocument = await FareModel.findOneAndUpdate({ _id: { $eq: req.query._id } }, req.body, { new: true });
