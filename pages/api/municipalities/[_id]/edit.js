...
export default async function municipalitiesEdit(req, res) {
  //
  await delay();
  ...
  try {
    const editedDocument = await MunicipalityModel.findOneAndReplace({ _id: req.query._id }, req.body, { new: true });
