...
import { Validation as AlertValidation } from '@/schemas/Alert/validation';
import { Default as AlertDefault } from '@/schemas/Alert/default';
...
export default function Page() {
  ...
  const form = useForm({
    ...
    initialValues: alertData || AlertDefault,
  });
