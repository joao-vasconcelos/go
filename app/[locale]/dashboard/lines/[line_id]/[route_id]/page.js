      ...
      header={
        <>
          <AutoSave
            ...
            closeType='back'
          />
          <LineDisplay short_name={lineData && lineData.short_name} name={form.values.name || t('untitled')} color={lineData && lineData.color} text_color={lineData && lineData.text_color} />
