...
mongorestore --uri="mongodb://slamanagerqueuedbuser:slamanagerqueuedbpassword@slamanagerqueuedb/production?authSource=admin" --drop --preserveUUID --gzip --archive="go-backup-slamanagerqueuedb-20240624213828"
