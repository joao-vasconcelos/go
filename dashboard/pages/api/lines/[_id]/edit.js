...
export default async function handler(req, res) {
  ...
  try {
    ...
    const foundDocumentWithLineId = await LineModel.exists({ code: { $eq: req.body.code } });
  ...
  try {
    const editedDocument = await LineModel.findOneAndUpdate({ _id: { $eq: req.query._id } }, req.body, { new: true });
